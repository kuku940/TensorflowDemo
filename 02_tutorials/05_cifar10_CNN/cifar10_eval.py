...
parser.add_argument('--eval_dir', type=str, default='../../data/tmp/cifar10/cifar10_eval',
                    help='Directory where to write event logs.')

parser.add_argument('--eval_data', type=str, default='test', help='Either `test` or `train_eval`.')

parser.add_argument('--checkpoint_dir', type=str, default='../../data/tmp/cifar10/cifar10_train',
