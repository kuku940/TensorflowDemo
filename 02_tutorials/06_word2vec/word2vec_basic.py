...
# reverse_dictionary - maps codes(integers) to words(strings) - 单词数，[ - codeword]
data, count, dictionary, reverse_dictionary = build_dataset(vocabulary, vocabulary_size)

del vocabulary  # Hint ro reduce memory
...
num_skips = 2  # How many time to reuse an input to generate a label
